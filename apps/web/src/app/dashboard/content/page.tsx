...
const CONTENT_TYPES = [
  {
    ...
    label: '商品标题',
    icon: '🏷️',
    desc: '根据商品卖点自动生成吸引点击的电商标题',
  },
  {
    key: 'listing',
    label: '商品详情页',
    icon: '📄',
    desc: '标准的 Amazon/eBay 详情描述与五点描述',
  },
  { key: 'faq', label: 'FAQ 问答', icon: '❓', desc: '针对商品的常见疑难问题进行专业解答' },
  {
    ...
    label: 'TikTok 脚本',
    icon: '🎬',
    desc: '适合短视频传播的带货口播与分镜头脚本',
  },
  {
    key: 'instagram',
    label: 'Instagram 文案',
    icon: '📸',
    desc: '配有热门标签与互动话题的社媒种草文案',
  },
  {
    key: 'facebook_ad',
    label: 'Facebook 广告',
    icon: '📢',
    desc: '高点击率的广告正文与吸睛标题组合',
  },
  {
    key: 'email_marketing',
    label: '邮件营销 (EDM)',
    icon: '📧',
    desc: '针对新客转化或老客复购的营销推介信',
  },
  {
    key: 'seo_blog',
    label: 'SEO 博客文章',
    icon: '📝',
    desc: '以行业关键词为核心的深度软文与导购指南',
  },
  {
    key: 'customer_service',
    label: '客服话术',
    icon: '💬',
    desc: '包含售前引导、售后纠纷处理的快捷回复语',
  },
  {
    key: 'landing_page',
    label: '营销落地页',
    icon: '🚀',
    desc: '符合消费心理学的单品落地页排版与文案',
  },
  {
    key: 'multilingual',
    label: '多语言翻译',
    icon: '🌍',
    desc: '针对本土文化优化的多语种地道翻译',
  },
  {
    key: 'brand_voice',
    label: '品牌语气改写',
    icon: '🎨',
    desc: '按照特定调性（幽默、科技、奢华）重新包装',
  },
];
