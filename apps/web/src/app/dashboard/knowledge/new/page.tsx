...
export default function NewKbPage() {
  ...
  async function create() { await apiClient.post('/kb', { name, description: desc }); router.push('/dashboard/knowledge'); }
  return (
    <div className="max-w-md space-y-4">
      ...
      <div className="space-y-2"><Label>描述</Label><Input value={desc} onChange={(e) => setDesc(e.target.value)} /></div>
